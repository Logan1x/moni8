            ...
            <>
              ...
              <section className="rounded-2xl border border-white/10 p-4">
                ...
                <div className="mt-3 grid gap-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="rounded-xl border border-white/[0.06] bg-white/[0.02] px-3 py-3">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="h-2.5 w-2.5 shrink-0 animate-pulse rounded-full bg-white/10" />
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <section className="rounded-2xl border border-white/10 p-4">
                <div className="space-y-4">
                  ...
                  <div className="h-48 animate-pulse rounded-2xl border border-white/10 bg-white/[0.02]" />
                </div>
              </section>
            </>
          ) : (
